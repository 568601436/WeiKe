...
//  WeiKe
//
//  Created by OSellMobile on 16/3/2.
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "CG.WeiKe" in the application's documents directory.
